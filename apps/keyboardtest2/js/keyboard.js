...
function getKeyboardSettings() {
  ...
  var values = { };
  values['language.current']        = 'en-US';
  values['keyboard.wordsuggestion'] = false;
  values['keyboard.vibration']      = false;
  values['keyboard.clicksound']     = false;

  function gotSettings(values) {
